...
de forma elegante.
"""
linha = int(input('tamanho da linha com + e -: '))
coluna = int(input('tanho da coluna com |:'))


def desenhar_linha(line):
    x = '-' * line
    print(f'+{x}+')


def desenhar_coluna(line, coluna):
...
def desenhar_retangulo(line, coluna):
    desenhar_linha(line)
    desenhar_coluna(line, coluna)
    desenhar_linha(line)


desenhar_retangulo(linha, coluna)
